...
<body id="page-top">
    ...
    <section class="about-section text-center">
        <div class="container mt-5">
            <h2 class="text-black mb-4">Register</h2>
            <form id="registerForm" method="post" action="<%=root%>/user/join">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="emailDomain" name="emailDomain" class="form-control" required>
                </div>
                <div class="form-group">
                ...
                <button type="submit" class="btn btn-secondary btn-sm mb-4">Register</button>
                <button type="reset" class="btn btn-secondary btn-sm mb-4">Reset</button>
            </form>
        </div>
