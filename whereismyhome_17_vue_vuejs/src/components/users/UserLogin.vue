...
const { userLogin, getUserInfo, findPassword } = memberStore
...
const find = async () => {
  await findPassword(loginUser.value)
  alert("비밀번호 찾기 메일이 전송되었습니다")
}
</script>
    ...
    <div class="row justify-content-center">
      ...
      <div class="col-lg-10">
        <form>
          ...
          <div class="form-check mb-3 float-end">
            <button class="form-check-label" @click="find"> 비밀번호 찾기 </button>
          </div>
          <div class="mb-3 text-start">
          ...
          <div class="col-auto text-center">
            ...
            <router-link to="join" class="btn btn-outline-success ms-1 mb-3">회원가입</router-link>
          </div>
        </form>
      </div>
    </div>
