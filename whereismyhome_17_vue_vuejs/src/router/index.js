...
const router = createRouter({
  ...
  routes: [
    ...
    {
      path: "/recentTrade",
      name: "apt-recentTrade",
      beforeEnter: onlyAuthUser,
      component: () => import("../views/RecentTrade.vue"),
    },
    {
      path: "/tradeRegist",
      name: "apt-tradeRegist",
      beforeEnter: onlyAuthUser,
      component: () => import("../views/TradeRegist.vue"),
    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          name: "user-aptlist",
          beforeEnter: onlyAuthUser,
          component: () => import("@/components/users/UserTradeList.vue"),
        },
      ],
    },
    {
